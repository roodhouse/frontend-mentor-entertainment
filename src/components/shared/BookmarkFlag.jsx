...
function BookmarkFlag() {
  ...
  return (
    <>
        <div id="bookmarkFlagContainer" onClick={handleClick} className='w-8 h-8 bg-darkBlue rounded-[50%] flex justify-center items-center opacity-50 mt-2 mr-2 md:mt-4 md:mr-6 absolute z-20'>
