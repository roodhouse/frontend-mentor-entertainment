  ...
  return (
    <>
        <div id="homeContainer">
            ...
            <div id="pageTitle" className='text-left text-white text-xl leading-normal tracking-[-0.312px] font-light pl-4 mb-6 md:text-[32px] md:tracking-[-.5px] md:pl-0'>
              <h2>{whatTitle()}</h2>
            </div>
            
            <div id="recommendedWrapper" className='flex flex-wrap px-4 justify-between md:pl-0 md:pr-6'>
           {
             Data.map((item) => {
                 if (!item.isTrending) {
                     return (
